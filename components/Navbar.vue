<template>
  <nav
    class="flex flex-wrap items-center justify-between w-full py-4 md:py-0 px-4 text-lg text-white bg-[#002447]"
  >
    <div>
      <a href="#">
        <svg
    ...
    <div :class="navtoggle" id="menu">
      <ul class="text-2xl pt-4 text-white md:flex md:justify-between md:pt-0">
        <li>
          <NuxtLink to="/">
